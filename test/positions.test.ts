...
import { ChangeProtocolFee, CreatePosition } from '../artifacts/ts'
  ...
  test('create position', async () => {
    ...
    await CreatePosition.execute(sender, {
      initialFields: {
        ...
        upperTickIndex: 2n,
        liquidityDelta: 100n,
        slippageLimitLower: 10n ** 24n,
        slippageLimitUpper: 10n ** 24n
      },
      attoAlphAmount: ONE_ALPH * 30n + DUST_AMOUNT * 2n
    })
  })
})
